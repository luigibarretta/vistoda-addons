...
USB archive has a separate paginated, read-only list with playback, download
and checksum-verified NFS copy; Vistoda deliberately does not expose provider
delete, eject, format or mount operations.
